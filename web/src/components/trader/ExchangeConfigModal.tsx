                ...
                <>
                  ...
                  {editingExchangeId && selectedExchange && (
                    ...
                    >
                      ...
                      currentExchangeType === 'kucoin'
                        ? language === 'zh'
                          ? ` · 口令：${selectedExchange.has_passphrase ? '已配置' : '未配置'}`
                  ...
                  >
                    <div className="flex items-start gap-2">
                      ...
                      <div>
                        ...
                        >
                          {language === 'zh'
                            ? '此处不支持手动输入私钥或 API 密钥。请使用 MetaMask、Rabby、OKX、Coinbase Wallet 等 EVM 钱包连接，授权交易代理并确认构建者费用。'
