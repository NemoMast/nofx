    ...
    <div style={{ fontFamily: 'var(--tm-mono)' }}>
      ...
      {!view ? (
        ...
        <div style={{ fontSize: 11 }}>
          ...
          >
            <span>{ui('price')}</span>
            <span style={{ textAlign: 'right' }}>{ui('size')}</span>
            <span style={{ textAlign: 'right' }}>{ui('cum $')}</span>
          </div>
          ...
          >
            ...
            <span className="tm-sc" style={{ marginLeft: 'auto' }}>
              {ui('spread')} {fmtPx(view.spread)} · {view.spreadBps.toFixed(1)}
              {ui('bps')}
            </span>
          </div>
          ...
          <div style={{ marginTop: 7 }}>
            ...
            >
              <span className="tm-up">
                {ui('B')} {view.bidPct.toFixed(1)}%
              </span>
              <span style={{ marginLeft: 'auto' }} className="tm-dn">
                {(100 - view.bidPct).toFixed(1)}
                {ui('% S')}
              </span>
            </div>
          </div>
