              ...
              {[
                {
                  icon: Command,
                  label:
                    language === 'zh' ? '一条命令安装' : 'One-Line Install',
                  desc:
                    language === 'zh'
                      ? '通过 Docker 管理全部依赖'
                      : 'Docker handles every dependency',
                },
                {
                  icon: Shield,
                  label:
                  ...
                  desc:
                    language === 'zh'
                      ? '在你的设备运行，密钥在本地加密保存'
                      : 'Runs on your machine, keys encrypted locally',
                },
              ].map((item, i) => (
                <div
                  key={i}
